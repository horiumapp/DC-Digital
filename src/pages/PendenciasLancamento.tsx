        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 p-6">
          ...
          <div className="mb-6 flex items-center justify-between border-t border-slate-100 dark:border-slate-700 pt-6">
            <button 
              ...
              className="flex items-center gap-2 px-8 py-3 bg-[#0f2851] text-white rounded-xl hover:bg-[#1a3a6d] transition-all text-sm font-black shadow-lg shadow-[#0f2851]/20 active:scale-95"
            >
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                {!hasSearched ? (
                  ...
                  docentesFiltrados.map((d, i) => (
                    <tr key={i} className="hover:bg-[#0f2851]/5 dark:hover:bg-slate-900 text-sm text-slate-600 dark:text-slate-300">
