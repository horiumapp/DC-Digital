...
export default function TabAlunos() {
  ...
  const handleSaveAluno = async (novoAluno: { escola_id: string; turma_id: string; nome: string; dataNascimento?: string; data_nascimento?: string; cpf?: string; sexo?: string; nomeResponsavel?: string; nome_responsavel?: string; telefone?: string; status?: string; endereco?: string }) => {
    ...
    if (alunoParaEditar) {
      ...
      if (error) {
        ...
        // Sincronizar escola_id na tabela usuarios (para transferÃªncias)
        if (novoAluno.cpf) {
      ...
      if (error) {
        ...
        showError("Erro ao criar aluno. Verifique se os dados sÃ£o vÃ¡lidos e tente novamente.");
      } else {
        ...
        if (newAluno && novoAluno.escola_id && novoAluno.cpf) {
          ...
          try {
            // FIX C2: senha temporÃ¡ria aleatÃ³ria forte â€” nunca mais "Aluno2026"
            ...
            if (authError || authData?.error) {
              ...
              showWarning(`Aluno cadastrado, mas nÃ£o foi possÃ­vel criar a conta de acesso: ${msg}`);
            } else {
              showSuccess(`Aluno ${novoAluno.nome} cadastrado! MatrÃ­cula (CPF): ${formatMatricula(newAluno.id, novoAluno.cpf)} | Senha: ${senhaTemporaria}`);
            }
          } catch (err: unknown) {
          ...
          showSuccess(`Aluno ${novoAluno.nome} cadastrado! CPF nÃ£o informado â€” a conta de acesso serÃ¡ criada quando o CPF for adicionado.`);
        }
      ...
      if (error) {
        ...
        if (alunoParaExcluir.cpf) {
          ...
          try {
            ...
            console.warn('Erro ao remover conta Auth do aluno excluÃ­do:', e);
          }
        }
        ...
        showSuccess("Aluno excluÃ­do com sucesso!");
      }
    }
  };
  ...
  // Agrupar turmas por turno para o acordeÃ£o
  const turnosOrdenados = ['MANHÃƒ', 'TARDE', 'NOITE', 'INTEGRAL'];
    ...
    <div className="flex flex-col h-full bg-slate-50/50 overflow-hidden">
      ...
      {!selectedEscola ? (
        ...
        <div className="flex flex-col shrink-0">
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p className="text-blue-100/80 text-sm mt-1 font-bold italic">
                    Gerencie matrÃ­culas e informaÃ§Ãµes dos estudantes.
                  </p>
                </div>
              </div>
          ...
          {/* Barra de Pesquisa e BotÃ£o Novo Aluno */}
            ...
            <div className="bg-white p-5 rounded-2xl shadow-xl shadow-blue-900/5 border border-slate-100 flex flex-col sm:flex-row items-end gap-4">
              <div className="flex-1 space-y-1.5 w-full">
                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">
                  BUSCAR ALUNO POR NOME, CPF OU RESPONSÃVEL
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    value={busca}
                    onChange={(e) => setBusca(e.target.value)}
                    placeholder="Ex: JoÃ£o Silva ou 123.456..."
      ...
      <div className="flex-1 overflow-y-auto p-8 pt-0">
        {!selectedEscola ? (
          ...
          <div className="space-y-12 pb-12">
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <div className="text-left">
                                ...
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">
                                  {turno} â€¢ {alunosDaTurma.length.toString().padStart(2, '0')} Alunos
                                </p>
                              </div>
                            </div>
                                ...
                                <table className="w-full text-left border-collapse">
                                  <thead>
                                    <tr className="border-b border-slate-100 bg-slate-50/50">
                                      <th className="px-6 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest w-16">NÂº</th>
                                      <th className="px-6 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest">Nome do Aluno</th>
                                      <th className="px-6 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest">ResponsÃ¡vel</th>
                                            ...
                                            <div className="flex items-center gap-3">
                                              ...
                                              <div className="flex flex-col min-w-0">
                                                ...
                                                <span className="text-[10px] font-bold text-slate-400 tabular-nums uppercase tracking-tight">
                                                  ...
                                                  MATRÃCULA: {aluno.cpf ? formatCpfObscured(aluno.cpf) : 'CPF Pendente'}
                                                </span>
                                              </div>
                                            </div>
                                          </td>
            ...
            {/* SeÃ§Ã£o Alunos Sem Turma (Opcional) */}
      ...
      <ConfirmActionModal
        ...
        message={
          <>
            Tem certeza que deseja excluir o(a) aluno(a) <strong>{alunoParaExcluir?.nome}</strong>? Esta aÃ§Ã£o nÃ£o pode ser desfeita.
          </>
        }
      />
    </div>
